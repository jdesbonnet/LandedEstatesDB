...
echo "\n    <li id=\"navfacdept\"><a accesskey=\"4\" tabindex=\"6\" title=\"" . $translation['faculties'][$thisLanguage] . " [access key '4']\" href=\"http://www.nuigalway.ie/faculties_departments/" . $querystring . "\">" . $translation['faculties'][$thisLanguage] . "</a>";
...
//Research
echo "\n    <li id=\"navresearch\"><a accesskey=\"5\" tabindex=\"7\" title=\"" . $translation['research'][$thisLanguage] . " [access key '5']\" href=\"http://www.nuigalway.ie/research/" . $querystring ."\">" . $translation['research'][$thisLanguage] . "</a></li>";
