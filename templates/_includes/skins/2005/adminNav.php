...
echo "\n    <li id=\"navadmin\"><a accesskey=\"6\" tabindex=\"8\" title=\"" . $translation['admin'][$thisLanguage] . " [access key '6']\" href=\"http://www.nuigalway.ie/administration_services/" . $querystring . "\">" . $translation['admin'][$thisLanguage] . "</a>";
