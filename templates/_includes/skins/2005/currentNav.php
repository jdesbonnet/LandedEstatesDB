...
//Current Students
echo "\n    <li id=\"navcurrent\"><a accesskey=\"3\" tabindex=\"5\" title=\"" . $translation['current'][$thisLanguage] . " [access key '3']\" href=\"http://www.nuigalway.ie/current_students/" . $querystring . "\">" . $translation['current'][$thisLanguage] . "</a>";
