...
public class TemplateRegistry {
	...
	private static Logger log = Logger.getLogger(TemplateRegistry.class);
	...
	public void init(String templatePath) throws TemplateException {
		...
		try {
			...
			Velocity.setProperty("eventhandler.include.class",
